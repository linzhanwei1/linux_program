/* Listing 52-4 */
/* pmsg_send.c
 * Usage as shown in usageError(). Send a message (specified as a command line argument) to a POSIX message queue.
...
{
    fprintf(stderr, "Usage: %s [-n] mq-name msg [prio]", progName);
