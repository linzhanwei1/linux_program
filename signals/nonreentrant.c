/* Listing 21-1 */
/* nonreentrant.c Demonstrate the nonreentrant nature of some library functions, in this example
 * crypt(3).
 */
 ...
 int main(int argc, char *argv[])
 {
    ...
    /* Repeatedly call crypt() using argv[1]. If interrupted by a signal handler, then the
     * static storage returned by crypt() will be overwritten by the results of encrypting
     * argv[2], and strcmp() will detect a mismatch with the value in 'crl'.
     */
